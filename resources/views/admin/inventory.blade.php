...
<br><br>
<div class="container">
    <h2 class="text-center">Inventory Details</h2><br>
    <div class="row">
        <div class="col-lg-12 text-center ">
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            <div class="modal-header text-center">
                                <h4 class="modal-title w-100 font-weight-bold">Add Inventory Details</h4>
            ...
            <!-- <div class="row ">
                <div class="text-center col-lg-12 d-flex justify-content-right ">
                    <a href="" class="btn btn-default btn-sm mb-4" data-toggle="modal" data-target="#modalRegisterForm">Add Inventory</a>
                </div>
            </div> -->
            ...
            <table class="table table-hover table-bordered ">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><a href="/admin/inventory/delete/{{$item->id}}" ><i class='fas fa-trash-alt'></i></a></td>
                    </tr>
